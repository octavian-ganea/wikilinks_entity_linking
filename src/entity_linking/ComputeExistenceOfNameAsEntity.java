...
public class ComputeExistenceOfNameAsEntity {
    ...
    private static HashMap<String, Integer> LoadAllEntitiesOrAllNames(String filename, String namesOrEnts) throws IOException {
    ...
    public static void run(String allEntsFilename, String allNamesFilename, String invdictSortedFilename, String dictFilename) throws IOException {
        HashMap<String, Integer> entsDocFreqsInCorpus = LoadAllEntitiesOrAllNames(allEntsFilename, "entities");
        HashMap<String, Integer> namesDocFreqsInCorpus = LoadAllEntitiesOrAllNames(allNamesFilename, "names");
