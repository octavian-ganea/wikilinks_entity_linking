...
scp -r run_config/ ganeao@cisco2.ethz.ch:/mnt/netapp/ganeao/wikilinks_project/
scp ./extract.jar ganeao@cisco2.ethz.ch:/mnt/netapp/ganeao/wikilinks_project/lib/
